...
if TYPE_CHECKING:
    ...
    from dockyard_rl.models.policy.interfaces import ReferenceLogprobOutputSpec

try:
    from dockyard_rl.distributed.batched_data_dict import BatchedDataDict as BatchedDataDict
except ImportError:
    pass

try:
    from dockyard_rl.models.policy.interfaces import ReferenceLogprobOutputSpec as ReferenceLogprobOutputSpec
except ImportError:
    pass
...
class AbstractPolicyWorker:
    ...
    def get_gpu_info(self) -> dict[str, Any]:
        ...
        from dockyard_rl.models.policy.utils import get_gpu_info
    ...
    def get_free_memory_bytes(self) -> int:
        ...
        from dockyard_rl.utils.nvml import get_free_memory_bytes
    ...
    def get_reference_policy_logprobs(
        ...
        *,
        ...
        return_data: "BatchedDataDict[ReferenceLogprobOutputSpec]" = BatchedDataDict()
