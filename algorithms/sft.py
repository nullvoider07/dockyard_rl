...
from dockyard_rl.algorithms.loss.loss_functions import NLLLossFn
...
class MasterConfig(BaseModel, extra="allow"):
    ...
    data: DataConfig
    sft: SFTConfig
    logger: "LoggerConfig"  # type: ignore[valid-type]
    cluster: ClusterConfig
    checkpointing: "CheckpointingConfig"  # type: ignore[valid-type]
...
def setup(
    ...
    # Detect VLM processor vs plain tokenizer
    processor = None
    ...
    loss_fn = NLLLossFn(use_linear_ce_fusion=False)
