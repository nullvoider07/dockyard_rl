...
from dockyard_rl.algorithms.loss import PreferenceLossFn
...
# Deferred imports for modules not yet written
if TYPE_CHECKING:
...
try:
    ...
    raise ImportError(
        "dockyard_rl.utils.timer is required for rm.py but has not been ported yet."
    )
...
def setup(
    ...
    Returns:
        ...
        loss_fn, logger, checkpointer, rm_save_state, master_config
    """
    ...
    rm_save_state: Optional[RMSaveState] = cast(
        Optional[RMSaveState], checkpointer.load_training_info(last_checkpoint_path)
    )
...
def validate_one_dataset(
    ...
    with timer.time("total_validation_time"):
        ...
        for batch_idx, val_batch in enumerate(val_dataloader):
            ...
            # Pad to the next multiple of micro_batch_size * dp_size.
            ...
            val_results = policy.train(
                ...
                eval_mode=True,
                gbs=val_batch.size,
                # Each preference example is a (chosen, rejected) pair — double mbs.
                mbs=val_mbs * 2,
            )
    ...
    timing_metrics: dict[str, float] = cast(dict[str, float], timer.get_timing_metrics(reduction_op="sum"))
...
def rm_train(
    ...
    if rm_save_state is None:
        ...
        total_valid_tokens = rm_save_state.get("total_valid_tokens", 0)
        ...
        for batch in train_dataloader:
            ...
            with timer.time("total_step_time"):
                ...
                train_results = policy.train(
                    ...
                    loss_fn,
                    eval_mode=False,
                    # Each preference example is a (chosen, rejected) pair — double gbs/mbs.
