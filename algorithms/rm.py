...
def setup(
    ...
    if loaded_state is not None:
        # Filter to only known RMSaveState fields; checkpoints may carry extra keys
        # (e.g. validation metrics from previous runs). Backcompat: checkpoints saved
        # before total_valid_tokens was added default it to 0.
