...
# Original copyright: ByteDance Ltd. and/or its affiliates, EleutherAI and the HuggingFace Inc. team.
...
def is_correct_minerva(
    ...
    if gt_need_extract:
        ...
        gt = normalize_final_answer(remove_boxed(boxed) if boxed is not None else gt)
    else:
...
def compute_score(
    ...
    strict_box_verify: bool = False,
    pause_tokens_index: Optional[list[int]] = None,
) -> dict[str, float | bool | Optional[str]]:
